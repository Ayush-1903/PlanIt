                ...
                <div className="login-content">
                    <form action="index.html">
                        ...
                        <div className="input-div one">
                            ...
                            <div className="div">
                                    <h5>Username</h5>   
                                    <input onFocus={addName} onBlur={remName} type="text" className="input"/>
                            </div>
                        </div>
                        ...
                        <div className="input-div one emails">
                            ...
                            <div className="div">
                                    <h5>Email Id</h5>   
                                    <input onFocus={addEmail} onBlur={remEmail} type="email" className="input"/>
                            </div>
                        </div>
                        ...
                        <div className="input-div pass effect">
                            ...
                            <div className="div">
                                    <h5>Password</h5>
                                    <input onFocus={addPass} onBlur={remPass} type="password" className="input"/>
                            </div>
                        </div>
