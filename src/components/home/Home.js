...
import './style.css';
import checklist from '../../assets/home-page/Checklist.svg';
import aboutus from '../../assets/home-page/About us.svg';
import chat from '../../assets/home-page/Chat.svg';
import setup from '../../assets/home-page/Setup.svg';
import todo from '../../assets/home-page/Todo.svg';
        ...
        <header>
          <nav className="navbar navbar-expand-lg">
            <div className="container-fluid">
              <a href="/" className="navbar-brand">Plan<span className="side-text">It!</span></a>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-4">
                <div className="card-service">
                  <div className="header">
                    <img className= "todoimg" src={todo} alt="" />
                  </div>
                  <div className="body">
              ...
              <div className="col-lg-4">
                <div className="card-service">
                  <div className="header">
                    <img className="organizeimg" src={setup} alt="" />
                  </div>
                  <div className="body">
